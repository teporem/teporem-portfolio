...
function App() {
  ...
  const project_experiences = [
    { date: 'Sept 2023 — Current', title: 'Haptic Hero', subtitle: 'Interdisciplinary Senior Design Project', details: ['AWS', 'React', 'Node.js', 'Express.js', 'Python', 'Raspberry Pi', 'Figma'], links: {"Github": "https://github.com/teporem/HapticHero", "More Info": "https://sites.google.com/stevens.edu/haptichero", "View": "https://teporem.github.io/HapticHero/"}, about: "Award-winning interdisciplinary project between Computer Science and Mechanical Engineering students to design and develop an accessible music-based rhythm game for individuals with visual impairments." },
